...
Dette vil antakelig ta en god stund å kjøre, ettersom Ollama må starte opp modellen. Det ser ut til at modellen får en /bye etter endt request.

```{r}
#req = create_request("http://localhost:11434/api/generate")
...
Dette ser faktisk ut til å funke. Ikke verst. Gleder meg til å teste dette mer.